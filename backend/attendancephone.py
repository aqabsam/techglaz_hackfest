...
# 1️ Path to save attendance Excel file on Desktop
desktop_path = os.path.join(os.path.expanduser("~"), "Desktop")
excel_file = os.path.join(desktop_path, "Attendance.xlsx")

# 2️ Create workbook and headers if not exists
...
ip = "http://10.159.171.3:4747/video"   
